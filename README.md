...
```
  ...
  --out     output file
```
Additionally, a pre-trained model trained with 476562 cells can also be [downloaded](https://drive.google.com/file/d/1v09bMQ5eO7YWXi6TKxPn4OZGj2rau_OE/view?usp=drive_link), and more pre trained models are being updated.
